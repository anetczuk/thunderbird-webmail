...
{  
    ...
    init : function()
    {
        ...
        var extension = rdfs.GetResource("urn:mozilla:item:{3d82b2c0-0109-11da-8cd6-0800200c9a66}");
        ...
        document.getElementById("OWAVersionNumber").setAttribute("value", version);
        ...
        document.getElementById("OWACreator").setAttribute("value", creator);
        ...
        document.getElementById("OWAHomePage").setAttribute("onclick", szHomePage);     
        document.getElementById("OWAHomePage").setAttribute("tooltiptext", homepage); 
