...
var displayName         = "WebMail - Yahoo"; // The name displayed to the user (don't include the version)
var version             = "1.4.7";
var name                = "yahoo"; // The leafname of the JAR file (without the .jar part)
...
var locales             = new Array( "en-US", "ca-AD", "da-DK", "de-DE", "es-AR", "es-ES", "fi-FI", "fr-FR", "it-IT", "lt-LT", "nb-NO", "nl-NL", "pt-BR", "pt-PT", "sk-SK", "sl-SI", "tr-TR", "zh-CN" );
var skins               = new Array( "classic" ); // "modern"
var prefs               = new Array( "yahoo.js" );
var components          = new Array( "nsIYahooDomains.xpt", "nsIYahooPOP.xpt", "nsIYahooSMTP.xpt", "nsYahooDomains.js", "nsYahooPOP.js", "nsYahooSMTP.js" );
