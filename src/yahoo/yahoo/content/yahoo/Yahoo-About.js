...
{  
    ...
    init : function()
    {
        ...
        var extension = rdfs.GetResource("urn:mozilla:item:{d7103710-6112-11d9-9669-0800200c9a66}");
        ...
        document.getElementById("YahooVersionNumber").setAttribute("value", version);
        ...
        document.getElementById("YahooCreator").setAttribute("value", creator);
        ...
        document.getElementById("YahooHomePage").setAttribute("onclick", szHomePage);     
        document.getElementById("YahooHomePage").setAttribute("tooltiptext", homepage); 
