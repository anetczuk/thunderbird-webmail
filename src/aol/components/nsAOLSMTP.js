...
nsAOLSMTP.prototype =
{
    classDescription : "Webmail AOL mail SMTP",
    classID          : Components.ID("{411242b0-9b47-11da-a72b-0800200c9a66}"),
    contractID       : "@mozilla.org/AOLSMTP;1",
...
if (XPCOMUtils.generateNSGetFactory)
    var NSGetFactory = XPCOMUtils.generateNSGetFactory([nsAOLSMTP]);
else
    var NSGetModule = XPCOMUtils.generateNSGetModule([nsAOLSMTP]);
