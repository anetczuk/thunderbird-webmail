...
{  
    ...
    init : function()
    {
        ...
        var extension = rdfs.GetResource("urn:mozilla:item:{1ad5b3b0-b908-11d9-9669-0800200c9a66}");
        ...
        document.getElementById("MailDotComVersionNumber").setAttribute("value", version);
        ...
        document.getElementById("MailDotComCreator").setAttribute("value", creator);
        ...
        document.getElementById("MailDotComHomePage").setAttribute("onclick", szHomePage);     
        document.getElementById("MailDotComHomePage").setAttribute("tooltiptext", homepage); 
